...
<div class="card-group">
  <div class="card">
    <img src="img\boys hostel front image.jpg" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card">
    <img src="img\inside hostel images1.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Card title</h5>
  ...
  <div class="card">
  <img src="img\hostelback.jpeg" class="card-img-top" alt="...">
